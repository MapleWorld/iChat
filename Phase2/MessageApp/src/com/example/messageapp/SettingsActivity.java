...
public class SettingsActivity extends PreferenceActivity {
	   ...
	   public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
			String serverAddress = PreferenceManager.getDefaultSharedPreferences(this).getString("pref_server_address", "");
			boolean serverIsHTTPS = PreferenceManager.getDefaultSharedPreferences(this).getBoolean("pref_server_https", true);
